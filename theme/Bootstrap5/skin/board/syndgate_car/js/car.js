$(function(){
	$(Grid.list).jqGrid({
		url : Grid.editUrl,
        datatype : "json",
		colNames:['번호','wr_id', '자산번호', '모델명', '제조사', '시리얼', '기타'],
		colModel : [
			...
			{ name:'wr_subject',index:'wr_subject', width:120, align:'center'},
			{ name:'wr_content',index:'wr_content', width:150, align:'center' },
			{ name:'wr_1',index:'wr_1', width:100, align:'center' },
			{ name:'wr_4',index:'wr_4', width:150, align:'center' },
			{ name:'wr_2',index:'wr_2', width:250, align:'center' },
		],
		loadui: 'enable',
		height: 450,
		autowidth:true,
