...
<div class="bo_w_tit write_div">
    <label for="wr_subject" class="sound_only">QR링크</label>
    <div id="autosave_wrapper" class="write_div">
    <?php
    // 게시글 URL 주소 생성
    $board_url = 'http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
    ?>
    <input type="text" name="wr_3" value="<?php echo $board_url; ?>" id="wr_3" class="frm_input full_input" size="50" maxlength="255" placeholder="QR코드 생성용 URL">
    </div>        
</div>
