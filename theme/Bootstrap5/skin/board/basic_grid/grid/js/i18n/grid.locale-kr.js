...
$.jgrid.regional["kr"] = {
	...
	del : {
		caption: "삭제",
		msg: "<span class='txt_blue txt_bold' style='font-size:11px;'>선택된 자료를 삭제하시겠습니까?<br/>주의 : 삭제한 자료는 복구가 불가능하니 주의하시기 바랍니다.</span>",
		bSubmit: "삭제",
		bCancel: "취소"
	},
	nav : {
		...
		addtext:"추가",
		addtitle: "추가",
		deltext: "<span class='txt_red'>선택삭제</span>",
		deltitle: "선택자료 삭제",
		searchtext: "검색",
		searchtitle: "검색",
		refreshtext: "새로고침",
